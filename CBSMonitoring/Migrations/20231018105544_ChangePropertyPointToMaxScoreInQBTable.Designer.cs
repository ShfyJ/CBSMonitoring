...
namespace CBSMonitoring.Migrations
{
    ...
    [Migration("20231018105544_ChangePropertyPointToMaxScoreInQBTable")]
    partial class ChangePropertyPointToMaxScoreInQBTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form2_1_2", b =>
                {
                    b.HasBaseType("CBSMonitoring.Models.OrgMonitoring");

                    b.Property<int?>("File_2_1_2Id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("File_2_1_2Id")
                        .IsUnique();

                    b.HasDiscriminator().HasValue("Form2_1_2");
                });
            ...
            modelBuilder.Entity("CBSMonitoring.Models.FileModel", b =>
                {
                    b.HasOne("CBSMonitoring.Models.Forms.Form2_2_2", "Form2_2_2")
                        .WithMany("FileModels")
                        .HasForeignKey("Form2_2_2Id");

                    b.Navigation("Form2_2_2");
                });
            ...
            modelBuilder.Entity("CBSMonitoring.Models.QualificationImprovedEmployee", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "Certificate")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.QualificationImprovedEmployee", "CertificateFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form1_1_1", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "FileModel")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.Forms.Form1_1_1", "File_1_1_1Id");
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form1_1_2", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "FileModel")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.Forms.Form1_1_2", "File_1_1_2Id");
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form1_1_3", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "FileModel")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.Forms.Form1_1_3", "File_1_1_3Id");
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form2_1_1", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "FileModel")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.Forms.Form2_1_1", "File_2_1_1Id");
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form2_1_2", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "FileModel")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.Forms.Form2_1_2", "File_2_1_2Id");
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form2_2_1", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "FileModel")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.Forms.Form2_2_1", "File_2_2_1Id");
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form2_3_1", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "FileModel")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.Forms.Form2_3_1", "File_2_3_1Id");
            ...
            modelBuilder.Entity("CBSMonitoring.Models.Forms.Form2_3_2", b =>
                {
                    b.HasOne("CBSMonitoring.Models.FileModel", "FileModel")
                        .WithOne()
                        .HasForeignKey("CBSMonitoring.Models.Forms.Form2_3_2", "File_2_3_2Id");
