...
namespace CBSMonitoring.Services
{
    public interface IGenericRepository
    {
        ...
        Task<IEnumerable<TEntity>> GetAllByParameterAsync<TEntity>(Expression<Func<TEntity, bool>> predicate, Func<IQueryable<TEntity>, IQueryable<TEntity>>? include = null) where TEntity : class;
