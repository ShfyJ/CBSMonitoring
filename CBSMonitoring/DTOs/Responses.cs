namespace CBSMonitoring.DTOs
{
    ...
    {
        public record ReportResponse(string PropertyLabel, object Value, int Order, string Type, bool ToBeDisplayed = false);
        ...
        public record QuestionBlockResponse(int BlockId, string BlockNumber, string BlockName, bool IsActive, 
                                                int Point, int? SectionCount=null, double? Completion = null);
