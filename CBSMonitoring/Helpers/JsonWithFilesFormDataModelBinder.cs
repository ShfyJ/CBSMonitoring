...
namespace CBSMonitoring.Helpers
{
    public class JsonWithFilesFormDataModelBinder : IModelBinder
    {
        ...
        public JsonWithFilesFormDataModelBinder(IOptions<JsonConfig> jsonConfig, ILoggerFactory loggerFactory)
        {
            _jsonSettings = jsonConfig.Value.JsonSerializerSettings;
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            var model = JsonConvert.DeserializeObject(rawValue, bindingContext.ModelType, _jsonSettings);
